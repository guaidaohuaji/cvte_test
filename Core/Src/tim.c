...
void MX_TIM1_Init(void)
{
  ...
  htim1.Instance = TIM1;
  htim1.Init.Prescaler = APP_PWM_INPUT_TIM_PSC;
  ...
  sConfigIC.ICFilter = APP_PWM_INPUT_IC_FILTER;
...
void MX_TIM6_Init(void)
{
  ...
  htim6.Instance = TIM6;
  htim6.Init.Prescaler = APP_DAMPER_TIM_PSC;
  htim6.Init.CounterMode = TIM_COUNTERMODE_UP;
  htim6.Init.Period = APP_DAMPER_TIM_ARR;
