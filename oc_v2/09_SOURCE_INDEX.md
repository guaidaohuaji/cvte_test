> **Step27提示**：本工程沿用Step26注释学习版，并修改NTC为Rcent查表换算。
> NTC测量范围为-40~120°C，AUTO范围仍为-25~60°C。
> 推荐阅读入口：`oc_v2/reference/learning/00_CODE_READING_GUIDE.md`。
...
覆盖上电1700步全开校准、校准期间BUSY、完成后0步参考、STOP/RELEASE/紧急停机中止和Master/Slave编译角色。
